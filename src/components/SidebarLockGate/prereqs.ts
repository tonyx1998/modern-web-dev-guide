...
export const PAGE_CHECKPOINTS: Record<string, string> = {
  ...
  'ai/ai-on-device': 'ai-on-device-page',
  ...
  'career/career-interview-prep': 'career-interview-prep-page',
  ...
  'lifecycle/working-with-coding-agents': 'lifecycle-coding-agents-page',
...
export const CHAPTER_PAGE_ORDER: Record<string, string[]> = {
  ...
  lifecycle: [
    ...
    'lifecycle/working-with-coding-agents',
    'lifecycle/testing',
