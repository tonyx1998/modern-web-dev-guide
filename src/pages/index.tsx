...
const PATHS: Path[] = [
  {
    ...
    cta: {label: 'Start with Foundations', to: '/docs/foundational-concepts'},
  },
  {
    ...
    cta: {label: 'Jump to Tech Stack', to: '/docs/tech-stack-decoded'},
  },
  {
  ...
  },
  {
    ...
    cta: {label: 'Skim the Tech Stack', to: '/docs/tech-stack-decoded'},
  },
];
    ...
    <section className={styles.cta}>
      <div className="container">
        ...
        <p className={styles.ctaText}>
          ...
          <Link to="/docs/foundational-concepts">chapter 1 (Foundations)</Link>.
