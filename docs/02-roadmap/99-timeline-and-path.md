...
3. **Lookup track — the rest of this guide.** When Stage *n* points at [Foundations](/docs/foundations) or [Tech Stack](/docs/stack), follow the link, read the page, return.
...
→ [Start with Stage 0](/docs/roadmap/part-1-from-zero/stage-0-setup) · [Read Part IV first](/docs/roadmap/part-4-meta)
