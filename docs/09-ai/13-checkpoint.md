...
In **Beginner mode**, you must pass (≥ 60%) to unlock the Next button and Chapter 10 in the sidebar. Switch the reading-level pill (top right) if you'd rather skip.
