...
description: Mandatory checkpoint quiz for Chapter 14 — Decision Frameworks. 5 random questions drawn from a 15-question bank. Pass to unlock Chapter 16.
---
...
You must pass (≥ 67%) to unlock the Next button and Chapter 15 in the sidebar.
...
→ Continue to [Chapter 16: Career Path](/docs/career) — how to grow as a web developer in 2026.
