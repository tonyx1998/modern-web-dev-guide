...
description: Mandatory checkpoint quiz for Chapter 7 — Enterprise. 5 random questions drawn from a 15-question bank. Pass to unlock Chapter 8.
---
...
→ Continue to [Chapter 8: Comparison](/docs/comparison) where we'll lay solo / startup / enterprise side-by-side.
